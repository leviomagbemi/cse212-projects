...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Enqueue method from PersonQueue class adds a person to the beginning of the queue instead of the end
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Missing condition in GetNextPerson method to account for when turns is 0
    ...
    // Defect(s) Found: Missing condition in GetNextPerson method to account for when turns is less than 0
